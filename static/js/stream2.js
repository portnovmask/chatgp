...
const submitIcon = `<img src="static/img/icons/send-2.svg" width="20" height="20" autofocus>`;

const stopIcon = `<img src="static/img/icons/player-stop.svg" width="20" height="20" autofocus>`;
          ...
          eventSource.onmessage = async (event) => {  // Добавляем `async`
                if (event.data !== undefined) {
                    ...
                    if (finishReason === "End") {
                       ...
                       <img src="static/img/icons/send-2.svg" width="20" height="20" autofocus>
                        </button>
                        </div>
                        </div>
                    `;
